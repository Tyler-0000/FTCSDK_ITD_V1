...
@Autonomous(name = "YOffsetPushTest")
public class YOffsetPushTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Push robot sideways (strafe) exactly 5 tiles (120 inches)");
        telemetry.update();
        waitForStart();
        ...
        while (opModeIsActive()) {
            ...
            double estimatedY = pose.y;
            double suggestedOffset = estimatedY == 0 ? 0 : TARGET_DISTANCE_INCHES / estimatedY;

            telemetry.addData("Estimated Y (in)", "%.2f", estimatedY);
            telemetry.addData("Expected Distance", "%.2f", TARGET_DISTANCE_INCHES);
            telemetry.addData("Suggested Y_OFFSET", "%.4f", suggestedOffset);
